...
IMAGE_TAG_BASE ?= arti.dev.cray.com/rabsw-docker-master-local/lustre-fs-operator
...
test: manifests generate fmt vet envtest ## Run tests.
	KUBEBUILDER_ASSETS="$(shell $(ENVTEST) use $(ENVTEST_K8S_VERSION) -p path)" go test -v ./... -coverprofile cover.out -args -ginkgo.v -ginkgo.progress
